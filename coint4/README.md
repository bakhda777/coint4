...
Политика выполнения: на этом сервере (146.103.41.248) не запускать никакие тяжёлые прогоны; все WFA/оптимизации/долгие бэктесты выполнять только на 85.198.90.128.

...
# Двухуровневая система штрафов
PENALTY_SOFT = -5.0   # Мягкий штраф за плохие, но посчитанные trials
PENALTY_HARD = -50.0  # Жёсткий штраф за системные ошибки
...
# ИСПРАВЛЕНО: Настройки для промежуточных отчетов - оптимизированная частота
INTERMEDIATE_REPORT_INTERVAL = 5   # Отчет каждые 5 пар для баланса между pruning и производительностью

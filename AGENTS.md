...
- Для работы скрипта задать `SERVSPACE_API_KEY` и `SERVER_ID` или `SERVER_NAME` (опционально: `SERVER_IP`, `SSH_KEY`, `SERVER_REPO_DIR`, `SERVER_WORK_DIR`, `SYNC_BACK`, `SYNC_PATHS`).

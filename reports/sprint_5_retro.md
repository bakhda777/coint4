...
- [ralph-tui-d02fa2fd] S5: Обновить optimization_state.md по текущему rollup
- [ralph-tui-2133ac36] S5: Синхронизировать статусы run_queue и пересобрать rollup (если надо)
- [ralph-tui-74e06792] S5: Подготовить remote-очередь tailguard/holdout на топ-кандидатов
- [ralph-tui-d6fbfed9] S5: Улучшить критерий отбора кандидатов (DD/tail/trades) в одном месте
- [ralph-tui-7e8c3457] (pad) Вспомогательная задача #6
- [ralph-tui-3704b4b2] S5: Sprint Retro + Plan Next Sprint
...
- S6: Обновить optimization_state.md по текущему rollup
- S6: Подготовить remote-очередь tailguard/holdout на топ-кандидатов
- S6: Синхронизировать статусы run_queue и пересобрать rollup (если надо)
- S6: Улучшить критерий отбора кандидатов (DD/tail/trades) в одном месте
- S6: Sprint Retro + Plan Next Sprint

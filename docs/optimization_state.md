...
Текущий снимок rollup: `2026-02-24 08:13:13Z` (из `coint4/artifacts/wfa/aggregate/rollup/run_index.md`).
...
Единый prefilter-gate (DD/tail/trades), который реально использует менеджер при выборе top-кандидатов из rollup: `tools/sprint_manager.py` (`CANDIDATE_GATE_V1`, можно переопределить флагами `--candidate-*`):

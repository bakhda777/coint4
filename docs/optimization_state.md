...
- Запланирован candidate sweep по риск-параметрам для baseline z0.95/0.08/120/120: `coint4/artifacts/wfa/aggregate/20260120_relaxed8_nokpss_u250_candidate_sweep/run_queue.csv`.

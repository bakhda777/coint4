...
- Далее: ещё ослабить фильтры (например, `min_correlation=0.6`, `pvalue=0.05`, `ssd_top_n=30000`, `max_hurst=0.58`) или снизить требования стабильности (window=1/min=1) и повторить shortlist.

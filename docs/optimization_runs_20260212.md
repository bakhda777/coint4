...
## Extra sweep: signal sprint17 (z micro-sweep under `vm10055`, 10 прогонов)
- Очередь: `coint4/artifacts/wfa/aggregate/20260212_budget1000_sharpe_signal_sprint17/run_queue.csv`
- Конфиги: `coint4/configs/budget_20260212_1000_sharpe_signal_sprint17/*.yaml`
- Размер: 10 прогонов (`5` вариантов `z1p14-z1p16` × `holdout/stress`)
- Статус: `10/10 completed`
- Валидация: `Sharpe consistency OK (10 run(s))`

### Матрица параметров (z1p14-z1p16)
Фиксируем лидера `vm10055` (`max_var_multiplier=1.0055`, `exit=0.08`, `ms=0.20`, `hold/cd=300`) и меняем только сигнал:
- `zscore_threshold`
...
| variant | kind | sharpe | pnl | max_dd | cost_ratio | trades | pairs |
|---|---|---:|---:|---:|---:|---:|---:|
| z1p14 | holdout | 4.241 | 2080.13 | -477.59 | 0.09 | 4634 | 58 |
| z1p14 | stress | 3.937 | 1838.38 | -468.03 | 0.18 | 4634 | 58 |
| z1p145 | holdout | 4.279 | 2114.14 | -478.50 | 0.09 | 4623 | 58 |
| z1p145 | stress | 3.975 | 1870.49 | -469.03 | 0.17 | 4623 | 58 |
| z1p15 | holdout | 4.380 | 2190.02 | -473.46 | 0.09 | 4610 | 58 |
| z1p15 | stress | 4.076 | 1942.05 | -464.39 | 0.17 | 4610 | 58 |
| z1p155 | holdout | 4.187 | 2045.96 | -459.76 | 0.09 | 4588 | 58 |
| z1p155 | stress | 3.886 | 1808.10 | -450.85 | 0.18 | 4588 | 58 |
| z1p16 | holdout | 4.113 | 1972.25 | -431.24 | 0.09 | 4575 | 58 |
| z1p16 | stress | 3.810 | 1739.66 | -423.97 | 0.18 | 4575 | 58 |

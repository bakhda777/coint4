...
11. Новый shortlist (3-5 конфигов) → 5-step WFA + holdout (max_steps=5).
    ...
    - Запланировано: turnover grid для baseline u250 без max_pairs (holdout + stress), очередь `coint4/artifacts/wfa/aggregate/20260120_relaxed8_nokpss_u250_turnover_full/run_queue.csv`.

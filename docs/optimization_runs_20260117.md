...
- Статус: `completed` (запуск на 85.198.90.128, очередь обновлена).
- Прогон 1 (holdout z0.95/0.08/120/120): sharpe_ratio_abs `3.9145`, total_pnl `137.90`, max_drawdown_abs `-37.41`, total_trades `1024`, total_pairs_traded `53`, total_costs `28.91`.
- Прогон 2 (holdout z1.05/0.08/120/120): sharpe_ratio_abs `3.8534`, total_pnl `128.71`, max_drawdown_abs `-21.51`, total_trades `630`, total_pairs_traded `53`, total_costs `18.04`.
- Прогон 3 (holdout z1.0/0.06/180/180): sharpe_ratio_abs `3.3057`, total_pnl `115.98`, max_drawdown_abs `-32.72`, total_trades `805`, total_pairs_traded `53`, total_costs `23.18`.
- Прогон 4 (stress z0.95/0.08/120/120): sharpe_ratio_abs `3.2811`, total_pnl `115.41`, max_drawdown_abs `-40.93`, total_trades `1024`, total_pairs_traded `53`, total_costs `51.40`.
- Прогон 5 (stress z1.05/0.08/120/120): sharpe_ratio_abs `3.4392`, total_pnl `114.68`, max_drawdown_abs `-23.52`, total_trades `630`, total_pairs_traded `53`, total_costs `32.07`.
...
- Конфиги (holdout + stress):
  ...
  - `coint4/configs/stress_20260119_relaxed8_nokpss_u250_turnover/stress_relaxed8_nokpss_u250_z1p0_exit0p06_hold180_cd180.yaml`
- Статус: `completed` (запуск на 85.198.90.128, очередь обновлена).
- Прогон 1 (holdout z0.95/0.08/120/120): sharpe_ratio_abs `4.5188`, total_pnl `447.87`, max_drawdown_abs `-60.19`, total_trades `3936`, total_pairs_traded `168`, total_costs `107.86`.
- Прогон 2 (holdout z1.05/0.08/120/120): sharpe_ratio_abs `4.1004`, total_pnl `438.07`, max_drawdown_abs `-64.75`, total_trades `2462`, total_pairs_traded `168`, total_costs `69.20`.
- Прогон 3 (holdout z1.0/0.06/180/180): sharpe_ratio_abs `4.1127`, total_pnl `400.06`, max_drawdown_abs `-62.95`, total_trades `3102`, total_pairs_traded `168`, total_costs `85.38`.
- Прогон 4 (stress z0.95/0.08/120/120): sharpe_ratio_abs `3.7022`, total_pnl `366.56`, max_drawdown_abs `-65.15`, total_trades `3936`, total_pairs_traded `168`, total_costs `191.75`.
- Прогон 5 (stress z1.05/0.08/120/120): sharpe_ratio_abs `3.6150`, total_pnl `385.94`, max_drawdown_abs `-66.22`, total_trades `2462`, total_pairs_traded `168`, total_costs `123.02`.
...
- Статус: `completed` (запуск на 85.198.90.128, очередь обновлена).
- Итоги (holdout / stress):
  - `risk0p01`: Sharpe `4.5188/3.7022`, PnL `447.87/366.56`, trades `3936`.
  - `risk0p02`: Sharpe `4.5188/3.7022`, PnL `447.87/366.56`, trades `3936`.
  - `maxpos10`: Sharpe `4.5225/3.7222`, PnL `446.31/367.04`, trades `3936`.
  - `maxpos20`: Sharpe `4.5293/3.7005`, PnL `450.15/367.31`, trades `3936`.
  - `kelly0p2`: Sharpe `4.5188/3.7022`, PnL `447.87/366.56`, trades `3936`.
  - `kelly0p3`: Sharpe `4.5188/3.7022`, PnL `447.87/366.56`, trades `3936`.
- Фильтрация (run.log): `coint4/results/filter_reasons_20260120_055005.csv`, `coint4/results/filter_reasons_20260120_055006.csv`, `coint4/results/filter_reasons_20260120_055008.csv`, `coint4/results/filter_reasons_20260120_055009.csv`, `coint4/results/filter_reasons_20260120_055010.csv`, `coint4/results/filter_reasons_20260120_055014.csv`, `coint4/results/filter_reasons_20260120_055111.csv`, `coint4/results/filter_reasons_20260120_055112.csv`, `coint4/results/filter_reasons_20260120_055113.csv`, `coint4/results/filter_reasons_20260120_055114.csv`, `coint4/results/filter_reasons_20260120_055118.csv`, `coint4/results/filter_reasons_20260120_055212.csv`, `coint4/results/filter_reasons_20260120_055213.csv`, `coint4/results/filter_reasons_20260120_055214.csv`, `coint4/results/filter_reasons_20260120_055215.csv`, `coint4/results/filter_reasons_20260120_055217.csv`, `coint4/results/filter_reasons_20260120_055218.csv`, `coint4/results/filter_reasons_20260120_055222.csv`, `coint4/results/filter_reasons_20260120_055311.csv`, `coint4/results/filter_reasons_20260120_055312.csv`, `coint4/results/filter_reasons_20260120_055313.csv`, `coint4/results/filter_reasons_20260120_055316.csv`, `coint4/results/filter_reasons_20260120_055317.csv`, `coint4/results/filter_reasons_20260120_055320.csv`, `coint4/results/filter_reasons_20260120_055408.csv`, `coint4/results/filter_reasons_20260120_055409.csv`, `coint4/results/filter_reasons_20260120_055410.csv`, `coint4/results/filter_reasons_20260120_055412.csv`, `coint4/results/filter_reasons_20260120_055416.csv`, `coint4/results/filter_reasons_20260120_055516.csv`, `coint4/results/filter_reasons_20260120_055518.csv`, `coint4/results/filter_reasons_20260120_055519.csv`, `coint4/results/filter_reasons_20260120_055558.csv`, `coint4/results/filter_reasons_20260120_055600.csv`, `coint4/results/filter_reasons_20260120_055602.csv`, `coint4/results/filter_reasons_20260120_055640.csv`, `coint4/results/filter_reasons_20260120_055641.csv`, `coint4/results/filter_reasons_20260120_055642.csv`, `coint4/results/filter_reasons_20260120_055643.csv`, `coint4/results/filter_reasons_20260120_055723.csv`, `coint4/results/filter_reasons_20260120_055724.csv`, `coint4/results/filter_reasons_20260120_055725.csv`, `coint4/results/filter_reasons_20260120_055807.csv`, `coint4/results/filter_reasons_20260120_055808.csv`.
- Итог: риск‑параметры почти не меняют метрики (идентичные результаты для risk/kelly); max_active_positions даёт минимальные изменения → оставляем baseline z0.95/0.08/120/120.

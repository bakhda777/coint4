...
- Optional: `coint4/configs/candidate_20260123_relaxed8_nokpss_u250_top50/candidate_relaxed8_nokpss_20260123_u250_top50_z1p00_exit0p06_hold180_cd180_ms0p2.yaml` (slightly лучше in‑sample, хуже на OOS 2025H1).

## Metrics (top50 baseline)
...
## Tradeoff notes
- ms0p2 даёт небольшое улучшение Sharpe/PNL в базовом holdout, но проигрывает на OOS 2025H1.
- z0.95/exit0.08 даёт максимум PnL, но ниже Sharpe; hold240 ухудшает метрики.
- top30 (z1.00/ms0p1) снижает turnover (~34% на OOS 2025H1), но Sharpe/PNL заметно ниже топ‑50, поэтому как опция не выбран.

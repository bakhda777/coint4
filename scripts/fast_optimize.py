#!/usr/bin/env python3
"""
Быстрый скрипт оптимизации для тестирования.
Использует унифицированный оптимизатор в fast режиме.
"""
...
def main():
    """Основная функция быстрой оптимизации."""
    parser = argparse.ArgumentParser(description="Быстрая оптимизация параметров")
    ...
    parser.add_argument('--output', '-o',
                       default='results/fast_optimization_results.db',

...
DEFAULT_N_PERIODS = 100  # Уменьшено с 500
DEFAULT_ROLLING_WINDOW = 20  # Уменьшено с 30
FAST_N_PERIODS = 50  # Для быстрых тестов
FAST_ROLLING_WINDOW = 10
DEFAULT_Z_THRESHOLD = 2.0
DEFAULT_VOLATILITY_LOOKBACK = 48
DEFAULT_CORRELATION_WINDOW = 120
DEFAULT_HURST_WINDOW = 240
DEFAULT_VARIANCE_RATIO_WINDOW = 180

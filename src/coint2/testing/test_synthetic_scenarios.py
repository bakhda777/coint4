...
class SyntheticScenariosTests:
    ...
    def test_perfect_mean_reversion(self):
        ...
        # На идеальных mean-reverting данных должна быть положительная доходность
        total_return = metrics.get('total_return', 0)
        sharpe_ratio = metrics.get('sharpe_ratio', 0)
        num_trades = metrics.get('num_trades', 0)
        
        assert total_return > 0, f"На mean-reverting данных ожидается прибыль: {total_return:.3f}"
        assert sharpe_ratio > 0.2, f"Sharpe должен быть разумным: {sharpe_ratio:.3f}"
        assert num_trades > 5, f"Должно быть достаточно сделок: {num_trades}"
        
        return {
            'test_name': 'perfect_mean_reversion',
            'status': 'PASSED',
    ...
    def test_trending_market_performance(self):
        ...
        return {
            'test_name': 'trending_market_performance',
            'status': 'PASSED',
            'total_return': total_return,
    ...
    def test_high_volatility_scenario(self):
        ...
        return {
            'test_name': 'high_volatility_scenario',
            'status': 'PASSED',
            'total_return': metrics.get('total_return', 0),
    ...
    def test_cointegration_breakdown(self):
        ...
        return {
            'test_name': 'cointegration_breakdown',
            'status': 'PASSED',
            'total_return': total_return,
            'sharpe_ratio': sharpe_ratio
        }
    ...
    def test_extreme_price_movements(self):
        ...
        return {
            'test_name': 'extreme_price_movements',
            'status': 'PASSED',
    ...
    def test_zero_volatility_period(self):
        ...
        return {
            'test_name': 'zero_volatility_period',
            'status': 'PASSED',
            'num_trades': num_trades
        }
